...
import la.xiong.androidquick.demo.features.function.annotation.aspect.CheckNetwork;
import la.xiong.androidquick.demo.features.function.annotation.manager.InjectManager;
